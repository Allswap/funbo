...
export function DexManager() {
  ...
  const [form, setForm] = useState({ name: '', address: '', chainId: '' });
              ...
              <tbody>
                {routers.map((r) => (
                  <tr key={r.id} className="border-b border-gray-800 hover:bg-gray-800/50">
                    ...
                    <td className="p-3 font-mono text-sm text-gray-400 truncate max-w-xs">{r.address}</td>
